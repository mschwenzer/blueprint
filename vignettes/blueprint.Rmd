...
Note that from a program point of view the fun is executed by sending it to mutate. If you selected var `v12` and the fun `ifelse(.>0,1,0)` blueprint will compute it as:
